...
def show_person(person_info: list) -> str:
    return "He/She is {} and his/her age is {}. He/She is working as {}.".format(person_info[0], person_info[1], person_info[2])
...
def show_book(book: dict) -> str:
    return "The guidebook {0} by {1} was published in {2}.".format(book['title'], book['author'], book['publication_year'])
...
def show_spaceship(spaceship: dict) -> str:
    return "The spaceship is called the {name}. It is a {type} used for {purpose}.".format(name=spaceship['name'], type=spaceship['type'], purpose=spaceship['purpose'])
